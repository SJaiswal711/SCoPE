...
# gcc -o serial_scope serial_scope.c \
#   -I$GSL_PATH/include \
...
gcc -o serial_scope serial_scope_emulator.c \
    emulator/src/emulator.c \
    emulator/src/training_buffer.c \
    emulator/src/pca_online.c \
    emulator/src/gp_online.c \
    emulator/src/transforms.c \
    emulator/src/utils.c \
    -I$GSL_PATH/include \
    -I/scratch/shambhavij.sps.iitmandi/SCoPE/data/clik/include \
    -I/scratch/shambhavij.sps.iitmandi/SCoPE/data/clik/src \
    -I/scratch/shambhavij.sps.iitmandi/SCoPE/data/clik/src/minipmc \
    -Iemulator/include \
    -I/scratch/shambhavij.sps.iitmandi/DIR/lapack-3.12.1/install/include \
    -L$GSL_PATH/lib \
    -L/scratch/shambhavij.sps.iitmandi/SCoPE/data/clik/lib \
    -L/scratch/shambhavij.sps.iitmandi/DIR/lapack-3.12.1/install/lib64 \
    -Wl,-rpath,/scratch/shambhavij.sps.iitmandi/SCoPE/data/clik/lib \
    -Wl,-rpath,/scratch/shambhavij.sps.iitmandi/SCoPE/CAMB/fortran/Releaselib \
    /scratch/shambhavij.sps.iitmandi/SCoPE/CAMB/fortran/Releaselib/camblib.so \
    -lclik -lgsl -lgslcblas -lgfortran -lm -llapacke -llapack -lblas